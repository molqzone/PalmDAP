...
{
 public:
  explicit DapProtocol(DapIo& io, TransferMethod transfer_method = nullptr);
   ...
   */
  void ExecuteCommand(const uint8_t* request,
 ...
 private:
   ...
   * @param response_callback Callback to send response data.
   */
  void ProcessCommand(const uint8_t* request,
                      LibXR::Callback<const uint8_t*, size_t> response_callback);
   ...
   */
  void HandleInfo(const uint8_t* req,
                  LibXR::Callback<const uint8_t*, size_t> response_callback);
   ...
   */
  void HandleHostStatus(const uint8_t* req,
                        LibXR::Callback<const uint8_t*, size_t> response_callback);
   ...
   */
  void HandleConnect(const uint8_t* req,
                     LibXR::Callback<const uint8_t*, size_t> response_callback);
   ...
   */
  void HandleDisconnect(LibXR::Callback<const uint8_t*, size_t> response_callback);
   ...
   * @param response_callback Callback to send response data.
   *
   * Command format: [0x04] [Idle_cycles] [Retry_count(L)] [Retry_count(H)]
   * [Match_retry(L)] [Match_retry(H)] Response format: [0x00=DAP_OK]
   */
  void HandleTransferConfigure(const uint8_t* req,
                               LibXR::Callback<const uint8_t*, size_t> response_callback);
   ...
   */
  void HandleTransfer(const uint8_t* req,
                      LibXR::Callback<const uint8_t*, size_t> response_callback);
   ...
   * @param response_callback Callback to send response data.
   *
   * Command format: [0x06] [DAP_index] [Transfer_count(L)] [Transfer_count(H)]
   * [Transfer_request] [Data...] Response format: [Transfer_count(L)] [Transfer_count(H)]
   * [Response_data...] [Status]
   */
  void HandleTransferBlock(const uint8_t* req,
                           LibXR::Callback<const uint8_t*, size_t> response_callback);
   ...
   * Response format: [Status=0x00=DAP_OK]
   */
  void HandleResetTarget(LibXR::Callback<const uint8_t*, size_t> response_callback);
   ...
   */
  void HandleSwjPins(const uint8_t* req,
                     LibXR::Callback<const uint8_t*, size_t> response_callback);
   ...
   * Response format: [0x00=DAP_OK]
   */
  void HandleSwjClock(const uint8_t* req,
                      LibXR::Callback<const uint8_t*, size_t> response_callback);
   ...
   * Response format: [0x00=DAP_OK]
   */
  void HandleSwjSequence(const uint8_t* req,
                         LibXR::Callback<const uint8_t*, size_t> response_callback);
   ...
   * Response format: [0x00=DAP_OK]
   */
  void HandleSwdConfigure(const uint8_t* req,
                          LibXR::Callback<const uint8_t*, size_t> response_callback);
   ...
   */
  void HandleSwdSequence(const uint8_t* req,
                         LibXR::Callback<const uint8_t*, size_t> response_callback);
